...
// Examples represents the examples loaded from config.json.
type Examples []*Example

// Example represents an example loaded from config.json.
type Example struct {
...
func main() {
	addr := flag.String("address", ":8083", "Address to host the HTTP server on.")
	flag.Parse()
...
// getExamples loads the examples from the config.json file.
